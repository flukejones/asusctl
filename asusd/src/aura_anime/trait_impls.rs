...
#[derive(Clone)]
pub struct AnimeMatrixZbus(AnimeMatrix);

impl AnimeMatrixZbus {
    pub fn new(anime: AnimeMatrix) -> Self {
        Self(anime)
    }
...
impl crate::CtrlTask for AnimeMatrixZbus {
...
impl crate::Reloadable for AnimeMatrixZbus {
